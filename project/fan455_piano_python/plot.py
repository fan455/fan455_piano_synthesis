...
def plot_pdf(x, title='probability density function', xlabel='x', ylabel='density', bgcolor='#D1DDC5', grid=True):
    ...
    x: 1d array.
    """
    sns.set_theme(rc={'axes.facecolor':bgcolor, 'axes.edgecolor':'grey', 'figure.facecolor':bgcolor})
...
def plot_scatter(y, x, title='scatter plot', xlabel='x', ylabel='y', equal_axis=False, \
                 save_path=None, bgcolor='#D1DDC5', grid=True, text_points=None):
    """
    Scatter plot of x and y.
    y, x: 1d array.
    test_points: like ['A1', 0, 1]
    """
    sns.set_theme(rc={'axes.facecolor':bgcolor, 'axes.edgecolor':'grey', 'figure.facecolor':bgcolor})
...
def plot_itp(y, x, points, title='title', xlabel='x', ylabel='y', \
             grid=True, bgcolor='#d1ddc5', equal_axis=False, save_path=None, \
...
def plot_au_mono(au, sr, title='title', grid=True, bgcolor='#D1DDC5', **kwargs):
    ...
    plot(au, t, title=title, xlabel='time (s)', ylabel='amplitude', grid=grid, \
...
def plot_au_stereo(au, sr, title='title', grid=True, bgcolor='#D1DDC5', **kwargs):
    ...
    """
    t = np.arange(au.shape[0])/sr
    subplots(au, t, nrows=2, ncols=1, yaxis=0, title=title, subtitle=('left channel', 'right channel'), \
